...
public class PostProcess_Dialog(EntityStack oEntityStack) : PostProcess(oEntityStack)
{
	...
	private const string PATH = "Content/Effects/Post/Post_Dialog";

	protected EffectData effectData;

	private float time;

	private float timeTotal = 1000f;

	public override void Load()
	{
		base.Load();
		effect = GameEngine.SceneContent.Load<Effect>("Content/Effects/Post/Post_Dialog");
