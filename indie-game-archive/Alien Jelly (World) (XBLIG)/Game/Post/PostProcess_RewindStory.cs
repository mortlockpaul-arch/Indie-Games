...
public class PostProcess_RewindStory : PostProcess
{
	...
	private const string PATH = "Content/Effects/Post/Post_RewindStory";
	...
	public PostProcess_RewindStory(EntityStack oEntityStack)
		: base(oEntityStack)
	{
	}
	...
	{
		base.Load();
		effect = GameEngine.SceneContent.Load<Effect>("Content/Effects/Post/Post_RewindStory");
		effectData.amount = effect.Parameters["gAmount"];
		effectData.offset = effect.Parameters["offset"];
