...
/// </summary>
public class EntityConstraintCollection : IEnumerable<TwoEntityConstraint>, IEnumerable
{
	/// <summary>
	///  Enumerator for the EntityConstraintCollection.
	/// </summary>
	public struct Enumerator : IEnumerator<TwoEntityConstraint>, IDisposable, IEnumerator
	{
		...
		/// </returns>
		public TwoEntityConstraint Current => current;
