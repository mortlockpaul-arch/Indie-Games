...
public class TransformableEntity : Entity<ConvexCollidable<TransformableShape>>
{
	...
	public ConvexShape Shape
	{
		get
		{
			return base.CollisionInformation.Shape.Shape;
		}
		set
		{
			base.CollisionInformation.Shape.Shape = value;
		}
	}
	...
	public Matrix3X3 Transform
	{
		get
		{
			return base.CollisionInformation.Shape.Transform;
		}
		set
		{
			base.CollisionInformation.Shape.Transform = value;
		}
	}
