...
/// </summary>
public class EntitySolverUpdateableCollection : IEnumerable<EntitySolverUpdateable>, IEnumerable
{
	/// <summary>
	///  Enumerator for the EntityConstraintCollection.
	/// </summary>
	public struct Enumerator : IEnumerator<EntitySolverUpdateable>, IDisposable, IEnumerator
	{
		...
		/// </returns>
		public EntitySolverUpdateable Current => current;
