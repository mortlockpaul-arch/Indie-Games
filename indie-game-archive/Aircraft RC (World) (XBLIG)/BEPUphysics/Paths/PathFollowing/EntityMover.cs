...
/// </summary>
public class EntityMover : Updateable, IDuringForcesUpdateable, ISpaceUpdateable, ISpaceObject
{
	...
	public Vector3 Offset
	{
		get
		{
			return LinearMotor.Point;
		}
		set
		{
			LinearMotor.Point = value;
		}
	}
	...
	public static Vector3 GetLinearVelocity(Vector3 start, Vector3 end, float dt)
	{
		...
		Vector3.Divide(ref result, dt, out result);
		return result;
	}
	...
	void IDuringForcesUpdateable.Update(float dt)
	{
		...
		else
		{
			...
			Vector3 start = Vector3.Transform(LocalOffset, entity.WorldTransform);
			Entity.LinearVelocity = GetLinearVelocity(start, TargetPosition, dt);
		}
	}
}
