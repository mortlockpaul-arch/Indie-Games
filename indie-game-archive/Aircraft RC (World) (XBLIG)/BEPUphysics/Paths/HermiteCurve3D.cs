...
public abstract class HermiteCurve3D : Curve<Vector3>
{
	...
	{
		value = Vector3.Hermite(base.ControlPoints[controlPointIndex].Value, tangents[controlPointIndex], base.ControlPoints[controlPointIndex + 1].Value, tangents[controlPointIndex + 1], weight);
	}
