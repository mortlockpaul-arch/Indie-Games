...
public static class MathChecker
{
	...
	{
		if (IsInvalid(m.M11) || IsInvalid(m.M12) || IsInvalid(m.M21) || IsInvalid(m.M22))
		{
			throw new NotFiniteNumberException("Invalid value.");
		}
	}
	...
	{
		if (IsInvalid(m.M11) || IsInvalid(m.M12) || IsInvalid(m.M21) || IsInvalid(m.M22) || IsInvalid(m.M31) || IsInvalid(m.M32))
		{
			throw new NotFiniteNumberException("Invalid value.");
		}
	}
	...
	{
		if (IsInvalid(m.M11) || IsInvalid(m.M12) || IsInvalid(m.M13) || IsInvalid(m.M21) || IsInvalid(m.M22) || IsInvalid(m.M23))
		{
			throw new NotFiniteNumberException("Invalid value.");
		}
	}
	...
	{
		if (IsInvalid(m.M11) || IsInvalid(m.M12) || IsInvalid(m.M13) || IsInvalid(m.M21) || IsInvalid(m.M22) || IsInvalid(m.M23) || IsInvalid(m.M31) || IsInvalid(m.M32) || IsInvalid(m.M33))
		{
			throw new NotFiniteNumberException("Invalid value.");
		}
	}
	...
	{
		if (IsInvalid(m.M11) || IsInvalid(m.M12) || IsInvalid(m.M13) || IsInvalid(m.M14) || IsInvalid(m.M21) || IsInvalid(m.M22) || IsInvalid(m.M23) || IsInvalid(m.M24) || IsInvalid(m.M31) || IsInvalid(m.M32) || IsInvalid(m.M33) || IsInvalid(m.M34) || IsInvalid(m.M41) || IsInvalid(m.M42) || IsInvalid(m.M43) || IsInvalid(m.M44))
		{
			throw new NotFiniteNumberException("Invalid value.");
		}
	}
