...
public struct AffineTransform
{
	...
	public Matrix Matrix
	{
		get
		{
			Matrix3X3.ToMatrix4X4(ref LinearTransform, out var b);
	...
	public AffineTransform(Vector3 scaling, Quaternion orientation, Vector3 translation)
	{
		...
		Matrix3X3.CreateFromQuaternion(ref orientation, out var result);
		Matrix3X3.Multiply(ref LinearTransform, ref result, out LinearTransform);
		Translation = translation;
	}
	...
	public static void TransformInverse(ref Vector3 position, ref AffineTransform transform, out Vector3 transformed)
	{
		...
		Matrix3X3.Invert(ref transform.LinearTransform, out var result);
		Matrix3X3.TransformTranspose(ref transformed, ref result, out transformed);
	}
	...
	{
		Matrix3X3.Multiply(ref a.LinearTransform, ref b.LinearTransform, out var result);
		Matrix3X3.Transform(ref a.Translation, ref b.LinearTransform, out var result2);
	...
	{
		Matrix3X3.CreateFromQuaternion(ref a.Orientation, out var result);
		Matrix3X3.Multiply(ref result, ref b.LinearTransform, out result);
		Matrix3X3.Transform(ref a.Position, ref b.LinearTransform, out var result2);
		Vector3.Add(ref result2, ref b.Translation, out transform.Translation);
		transform.LinearTransform = result;
	}
	...
	public static AffineTransform CreateFromRigidTransform(RigidTransform rigid)
	{
		...
		Matrix3X3.CreateFromQuaternion(ref rigid.Orientation, out result.LinearTransform);
		return result;
	}
}
