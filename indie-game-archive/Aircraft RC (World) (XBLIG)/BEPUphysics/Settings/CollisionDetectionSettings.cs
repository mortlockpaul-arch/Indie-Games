...
{
	internal static float ContactInvalidationLengthSquared = 0.01f;

	internal static float ContactMinimumSeparationDistanceSquared = 0.0009f;

	internal static float nonconvexNormalDotMinimum = 0.99f;
	...
	internal static float maximumContactDistance = 0.1f;
