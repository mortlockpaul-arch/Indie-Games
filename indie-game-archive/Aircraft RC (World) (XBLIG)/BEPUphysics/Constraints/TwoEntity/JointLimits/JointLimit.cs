...
public abstract class JointLimit : Joint
{
	...
	/// </summary>
	protected float bounceVelocityThreshold = 1f;
	...
	public float BounceVelocityThreshold
	{
		get
		{
			return bounceVelocityThreshold;
		}
		set
		{
			bounceVelocityThreshold = Math.Max(0f, value);
		}
	}
	...
	public float Bounciness
	{
		...
		set
		{
			bounciness = MathHelper.Clamp(value, 0f, 1f);
		}
	}
	...
	public float Margin
	{
		...
		set
		{
			margin = MathHelper.Max(value, 0f);
		}
	}
}
