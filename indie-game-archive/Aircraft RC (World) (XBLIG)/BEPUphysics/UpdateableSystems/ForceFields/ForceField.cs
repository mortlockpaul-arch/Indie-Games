...
/// </summary>
public abstract class ForceField : Updateable, IDuringForcesUpdateable, ISpaceUpdateable, ISpaceObject
{
	...
	{
		Entity entity = affectedEntities[index];
		if (entity.isDynamic && (entity.activityInformation.IsActive || ForceWakeUp) && Shape.IsEntityAffected(entity))
		{
			if (ForceWakeUp)
			{
				entity.activityInformation.Activate();
			}
			CalculateImpulse(entity, currentTimestep, out var impulse);
