...
/// </summary>
public abstract class CombinedUpdateable : EntitySolverUpdateable, ISpaceUpdateable, ISpaceObject
{
	...
	public bool IsUpdatedSequentially
	{
		get
		{
			return isSequentiallyUpdated;
		}
		set
		{
			bool flag = isSequentiallyUpdated;
