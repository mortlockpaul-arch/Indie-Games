...
/// </summary>
public struct EntityCollidableCollection : IEnumerable<Entity>, IEnumerable
{
	/// <summary>
	///  Enumerator for the EntityCollidableCollection.
	/// </summary>
	public struct Enumerator : IEnumerator<Entity>, IDisposable, IEnumerator
	{
		...
		public bool MoveNext()
		{
			...
			{
				if ((current = ((collection.owner.pairs[index].broadPhaseOverlap.entryA == collection.owner) ? collection.owner.pairs[index].broadPhaseOverlap.entryB : collection.owner.pairs[index].broadPhaseOverlap.entryA) as EntityCollidable) != null)
				{
					return true;
				}
			}
