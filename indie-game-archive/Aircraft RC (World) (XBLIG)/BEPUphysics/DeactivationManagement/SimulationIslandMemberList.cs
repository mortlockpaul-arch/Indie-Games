...
/// </summary>
public struct SimulationIslandMemberList : IList<SimulationIslandMember>, ICollection<SimulationIslandMember>, IEnumerable<SimulationIslandMember>, IEnumerable
{
	/// <summary>
	/// Enumerators the simulation island members in the member list.
	/// </summary>
	public struct Enumerator : IEnumerator<SimulationIslandMember>, IDisposable, IEnumerator
	{
