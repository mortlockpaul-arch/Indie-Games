...
/// </summary>
public class SunBurnSkinnedEffect : SkinnedEffect, IExtendedXNAEffect, ICollisionMaterial
{
	private int HCB;
	...
	/// </summary>
	public SunBurnSkinnedEffect(GraphicsDevice device)
		: base(device)
	{
	}
	...
	{
		Effect effect = new SunBurnSkinnedEffect(base.GraphicsDevice);
