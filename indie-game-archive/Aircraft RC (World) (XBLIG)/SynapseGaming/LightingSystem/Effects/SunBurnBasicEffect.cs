...
/// </summary>
public class SunBurnBasicEffect : BasicEffect, IExtendedXNAEffect, ICollisionMaterial
{
	private int HCB;
	...
	/// </summary>
	public SunBurnBasicEffect(GraphicsDevice device)
		: base(device)
	{
	}
	...
	{
		Effect effect = new SunBurnBasicEffect(base.GraphicsDevice);
