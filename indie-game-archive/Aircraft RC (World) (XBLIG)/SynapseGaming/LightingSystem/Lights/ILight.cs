...
/// </summary>
public interface ILight : IMovableObject, IWorldBoundingBoxObject, IComponentObject<ILight>, IEditorCreatedObject<ILight>, IEditorObject, INamedObject
{
	/// <summary>
	...
	/// </summary>
	LightingType LightingType { get; set; }
