...
internal class LineRender
{
	...
	public LineRender(GraphicsDevice graphicsDevice, ContentManager contentManager, Rectangle backBufferArea)
	{
		_effect = contentManager.Load<Effect>("ForeverWars/Effects/LineEffect");
	...
	public void DrawShape(VertexPositionColor[] vertices)
	{
		VertexPositionColor[] array = new VertexPositionColor[vertices.Length];
		for (int i = 0; i < vertices.Length; i++)
		{
