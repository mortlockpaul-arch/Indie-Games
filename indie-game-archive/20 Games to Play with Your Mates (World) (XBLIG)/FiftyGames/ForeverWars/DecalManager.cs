...
public class DecalManager
{
	...
	public DecalManager(GraphicsDevice graphicsDevice, ContentManager content, Rectangle backBufferRect, Rectangle sourceRect, Texture2D texture)
	{
		...
		_texture = texture;
		_effect = content.Load<Effect>("ForeverWars/Effects/DecalManagerEffect");
	...
	{
		_graphicsDevice.SetVertexBuffers(new VertexBufferBinding(_vb, 0, 0), new VertexBufferBinding(dvb, 0, 0));
	}
