...
internal static class LightBikesHelper
{
	...
	{
		new Rectangle((int)(position.X - spriteFont.MeasureString(text).X / 2f), (int)(position.Y - spriteFont.MeasureString(text).Y / 2f), (int)spriteFont.MeasureString(text).X, (int)spriteFont.MeasureString(text).Y);
