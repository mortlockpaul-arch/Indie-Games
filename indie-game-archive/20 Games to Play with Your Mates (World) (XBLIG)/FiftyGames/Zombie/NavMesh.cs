...
internal class NavMesh
{
	...
	public NavMesh(int numberOfNodes)
	{
		_lineMesh = new LineMesh(100);
	...
	public NavMesh(int numberOfNodes, Stream fileStream)
	{
		_lineMesh = new LineMesh(numberOfNodes);
		_numberOfNodes = numberOfNodes;
		dist = new float[numberOfNodes, numberOfNodes];
		d = new float[numberOfNodes];
		visited = new int[numberOfNodes];
	...
	{
		_lineMesh = new LineMesh(_numberOfNodes);
	...
	{
		_lineMesh.DrawMesh(spriteBatch, offset);
	}
}
