...
public class Passion : SpecialCharacter
{
	...
	public Passion(Player pPlayer)
	{
		m_Player = pPlayer;
		m_SpecialTime = 0f;
		ParticleEffect pe = m_Player.m_GameStateInstance.content.Load<ParticleEffect>("Fx/Particle/PassionSpecial");
	...
	public override void Update(GameTime gameTime)
	{
		...
		for (int i = 0; i < m_Player.m_GameStateInstance.m_Players.Count; i++)
		{
			...
			if (Vector2.Distance(m_Player.m_GameStateInstance.m_Players[i].GetPosition(), m_Player.GetPosition()) < 100f && m_Player.m_GameStateInstance.m_Players[i].m_Tag == 0)
			{
