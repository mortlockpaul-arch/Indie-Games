...
internal class TimeSyncClient
{
	...
	public void SendTimeSyncRequest(int realTimeMs)
	{
		try
		{
			((BinaryWriter)(object)m_PacketWriter).Write((byte)1);
			m_PacketSequenceNumber++;
			((BinaryWriter)(object)m_PacketWriter).Write(m_PacketSequenceNumber);
			m_Sender.SendData(m_PacketWriter, (SendDataOptions)2, m_Host);
	...
	public void ProcessTimeSyncResponse(int realTimeMs)
	{
		...
		ushort num2 = ((BinaryReader)(object)m_PacketReader).ReadUInt16();
