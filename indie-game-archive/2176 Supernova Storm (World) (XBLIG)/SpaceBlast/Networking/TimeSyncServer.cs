...
internal class TimeSyncServer
{
	...
	{
		ushort value = ((BinaryReader)(object)m_PacketReader).ReadUInt16();
		((BinaryWriter)(object)m_PacketWriter).Write((byte)2);
		((BinaryWriter)(object)m_PacketWriter).Write((int)(TimeManager.TotalSeconds * 1000.0));
		((BinaryWriter)(object)m_PacketWriter).Write(value);
		m_Sender.SendData(m_PacketWriter, (SendDataOptions)2, from);
	}
}
