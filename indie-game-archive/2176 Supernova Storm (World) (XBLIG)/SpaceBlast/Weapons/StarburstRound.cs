...
internal class StarburstRound : WeaponRound
{
	private const int constGunDamage = 100;
	...
	public StarburstRound(Vector3 position, Vector3 velocity, double expires)
	{
	...
	public unsafe static void SetupStatics()
	{
		...
		s_Model = MainGame.ContentMan.Load<Model>("Models/VBlaster");
