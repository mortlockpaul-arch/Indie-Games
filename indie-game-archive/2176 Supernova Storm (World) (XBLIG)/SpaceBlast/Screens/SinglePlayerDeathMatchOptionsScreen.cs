...
internal class SinglePlayerDeathMatchOptionsScreen : MenuScreen
{
	private Rectangle m_ScreenRect;

	private int m_LastSelectedIndex = 2;

	public SinglePlayerDeathMatchOptionsScreen(ScreenManager manager)
		: base(manager)
	{
	...
	protected override void OnGreenButtonPressed()
	{
		...
		SinglePlayerGameOptions singlePlayerGameOptions = new SinglePlayerGameOptions();
		singlePlayerGameOptions.Skill = (Difficulty)base.SelectedItemID;
		MainGame.Instance.StartNewGame(singlePlayerGameOptions);
