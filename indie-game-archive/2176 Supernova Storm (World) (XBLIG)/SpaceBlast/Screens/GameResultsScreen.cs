...
internal class GameResultsScreen : MenuScreen
{
	...
	public override void Draw(float alpha)
	{
		...
		((Color)(ref yellow)).A = (byte)(alpha * 255f);
		...
		((Vector2)(ref center2))._002Ector((float)((Rectangle)(ref m_ScreenRect)).Left + (float)m_ScreenRect.Width * 0.2f, center.Y);
		Vector2 center3 = default(Vector2);
		((Vector2)(ref center3))._002Ector((float)((Rectangle)(ref m_ScreenRect)).Left + (float)m_ScreenRect.Width * 0.25f, center.Y);
		Vector2 center4 = default(Vector2);
		((Vector2)(ref center4))._002Ector((float)((Rectangle)(ref m_ScreenRect)).Left + (float)m_ScreenRect.Width * 0.8f, center.Y);
	...
	public override void OnShowScreen()
	{
		...
		{
			Utils.SetRichPresence((GamerPresenceMode)50, null);
		}
		else
		{
			Utils.SetRichPresence((GamerPresenceMode)49, null);
		}
		RedButtonText = "Exit";
	...
	private void RecalcScreenRect()
	{
		...
		((Vector2)(ref val))._002Ector(600f, 500f);
		val.Y = 150 + MainGame.Players.Count * 40;
