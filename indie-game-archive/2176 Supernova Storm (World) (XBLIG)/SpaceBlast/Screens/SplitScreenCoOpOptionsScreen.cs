...
internal class SplitScreenCoOpOptionsScreen : MenuScreen
{
	private Rectangle m_ScreenRect;

	private int m_LastSelectedIndex = 2;

	public SplitScreenCoOpOptionsScreen(ScreenManager manager)
		: base(manager)
	{
	...
	protected override void OnGreenButtonPressed()
	{
		...
		SplitScreenCoOpGameOptions splitScreenCoOpGameOptions = new SplitScreenCoOpGameOptions();
		splitScreenCoOpGameOptions.Skill = (Difficulty)base.SelectedItemID;
		MainGame.Instance.StartNewGame(splitScreenCoOpGameOptions);
