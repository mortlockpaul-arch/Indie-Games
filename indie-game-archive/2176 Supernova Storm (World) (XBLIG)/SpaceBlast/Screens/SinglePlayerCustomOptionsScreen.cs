...
internal class SinglePlayerCustomOptionsScreen : MenuScreen
{
	private Rectangle m_ScreenRect;

	public SinglePlayerCustomOptionsScreen(ScreenManager manager)
		: base(manager)
	{
	...
	{
		SinglePlayerCustomOptions gameOptions = new SinglePlayerCustomOptions();
