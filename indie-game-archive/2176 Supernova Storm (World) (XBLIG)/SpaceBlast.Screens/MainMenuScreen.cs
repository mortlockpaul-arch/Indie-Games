...
internal class MainMenuScreen : MenuScreen
{
	...
	protected override void OnGreenButtonPressed()
	{
		...
		case 2:
			...
			break;
		case 3:
			m_ScreenManager.ShowScreen(ScreenType.MultiplayerMenuScreen);
			break;
		case 4:
	...
	public override void OnShowScreen()
	{
		...
		MenuItems.Add(new MenuItem("Exit to Dashboard", 8));
		RedButtonText = null;
	...
	{
		Vector2 vector = new Vector2(600f, 350f);
	...
	public override void Update()
	{
		...
		{
			m_ScreenManager.ShowScreen(ScreenType.TrialMainMenu);
		}
		base.Update();
	}
}
