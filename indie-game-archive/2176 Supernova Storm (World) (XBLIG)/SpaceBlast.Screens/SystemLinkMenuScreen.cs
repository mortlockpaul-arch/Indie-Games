...
internal class SystemLinkMenuScreen : MenuScreen
{
	private Rectangle m_ScreenRect;

	public SystemLinkMenuScreen(ScreenManager manager)
		: base(manager)
	{
	...
	protected override void OnGreenButtonPressed()
	{
		...
		{
		case 0:
			MainGame.NetMan.SignIn(NetworkSessionType.SystemLink, SystemLinkSignInCompleteEvent, null);
			break;
		case 1:
			...
			{
				m_ScreenManager.ShowScreen(ScreenType.SystemLinkCustomGameScreen);
			}
			break;
		}
	...
	private void SystemLinkSignInCompleteEvent(object sender, EventArgs e)
	{
