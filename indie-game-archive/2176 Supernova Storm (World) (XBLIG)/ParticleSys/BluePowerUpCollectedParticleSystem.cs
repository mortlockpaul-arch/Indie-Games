...
internal class BluePowerUpCollectedParticleSystem : ParticleSystem
{
	public BluePowerUpCollectedParticleSystem(Game game, ContentManager content)
		: base(game, content)
	{
	}
	...
	{
		settings.TextureName = "Textures/PUPS_Blue";
