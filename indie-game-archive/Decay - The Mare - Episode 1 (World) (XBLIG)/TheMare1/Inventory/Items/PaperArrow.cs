...
public class PaperArrow : Item
{
	public const string ID = "PaperArrow";

	public PaperArrow(Core.Game game, ContentManager CM)
		: base(game)
	{
		m_icon = CM.Load<Texture2D>("Inventory/Items/PaperArrow/arrow_thumb");
	...
	public override void onLoadExamine(SGSContentLoader CL)
	{
		try
		{
			...
			{
				m_examine_image = CL.m_CM.Load<Texture2D>("Inventory/Items/PaperArrow/poetry_arrow");
			}
		}
		catch (Exception ex)
		{
