...
public class PaperFlame : Item
{
	public const string ID = "PaperFlame";

	public PaperFlame(Core.Game game, ContentManager CM)
		: base(game)
	{
		m_icon = CM.Load<Texture2D>("Inventory/Items/PaperFlame/flame_thumb");
	...
	public override void onLoadExamine(SGSContentLoader CL)
	{
		try
		{
			...
			{
				m_examine_image = CL.m_CM.Load<Texture2D>("Inventory/Items/PaperFlame/poetry_flame");
			}
		}
		catch (Exception ex)
		{
