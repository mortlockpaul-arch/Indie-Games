...
public class PaperTear : Item
{
	public const string ID = "PaperTear";

	public PaperTear(Core.Game game, ContentManager CM)
		: base(game)
	{
		m_icon = CM.Load<Texture2D>("Inventory/Items/PaperTear/tear_thumb");
	...
	public override void onLoadExamine(SGSContentLoader CL)
	{
		try
		{
			...
			{
				m_examine_image = CL.m_CM.Load<Texture2D>("Inventory/Items/PaperTear/poetry_tear");
			}
		}
		catch (Exception ex)
		{
