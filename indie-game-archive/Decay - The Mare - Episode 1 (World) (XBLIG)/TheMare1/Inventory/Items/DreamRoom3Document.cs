...
public class DreamRoom3Document : Item
{
	public const string ID = "DreamRoom3Document";

	public DreamRoom3Document(Core.Game game, ContentManager CM)
		: base(game)
	{
		m_icon = CM.Load<Texture2D>("Inventory/Items/DreamRoom3Document/mazepuzzle2_thumb");
	...
	public override void onLoadExamine(SGSContentLoader CL)
	{
		try
		{
			...
			{
				m_examine_image = CL.m_CM.Load<Texture2D>("Inventory/Items/DreamRoom3Document/document_maze2");
			}
		}
		catch (Exception ex)
		{
