...
public class RedGlow : BaseParticle
{
	...
	{
		SpriteTools.sprite.Draw(Game1.vgame.spritesTex, VScroll.GetScreenLoc(p.loc, 1f), new Rectangle(128, 64, 128, 128), new Color(1f, 0.1f, 0.1f, p.frame * 5f), 0f, new Vector2(64f, 64f), p.size * VScroll.zoom, SpriteEffects.None, 1f);
	}
}
