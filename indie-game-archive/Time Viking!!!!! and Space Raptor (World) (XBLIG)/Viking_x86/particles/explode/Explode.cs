...
public class Explode : BaseParticle
{
	...
	public override void Draw(Particle p)
	{
		...
		{
			SpriteTools.sprite.Draw(Game1.vgame.spritesTex, VScroll.GetScreenLoc(p.loc, 1f), new Rectangle(0, 0, 128, 128), new Color(1f, 1f, 1f, 1f), 0f, new Vector2(64f, 64f), p.size * VScroll.zoom, SpriteEffects.None, 1f);
		}
	}
}
