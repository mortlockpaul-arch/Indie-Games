...
public class Spitnel : BaseParticle
{
	...
	{
		SpriteTools.sprite.Draw(Game1.vgame.spritesTex, VScroll.GetScreenLoc(p.loc, 1f), new Rectangle(576, 256 + Rand.GetRandomInt(0, 3) * 64, 128, 64), new Color(p.r, 1f, 0.2f, 0.5f), p.angle + VScroll.angle, new Vector2(0f, 32f), 0.45f * VScroll.zoom * p.size, SpriteEffects.None, 1f);
	}
}
