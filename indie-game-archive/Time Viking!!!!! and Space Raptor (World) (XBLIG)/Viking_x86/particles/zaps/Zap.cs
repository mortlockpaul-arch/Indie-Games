...
public class Zap : BaseParticle
{
	...
	{
		SpriteTools.sprite.Draw(Game1.vgame.spritesTex, VScroll.GetScreenLoc(p.loc, 1f), new Rectangle(128 + Rand.GetRandomInt(0, 6) * 128, 0, 128, 64), new Color(1f, 1f, 1f, 1f), p.angle + VScroll.angle + 3.14f, new Vector2(0f, 32f), 0.5f * VScroll.zoom, SpriteEffects.None, 1f);
	}
}
