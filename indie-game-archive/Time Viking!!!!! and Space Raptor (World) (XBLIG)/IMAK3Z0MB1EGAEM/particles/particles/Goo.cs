...
public class Goo : BaseParticleDef
{
	...
	{
		SpriteTools.sprite.Draw(ZombieGame.spritesTex, ScrollMan.GetScreenLoc(p.loc, 1f), new Rectangle(256, 832, 64, 64), new Color(1f, 1f, 1f, p.frame * 5f), 0f, new Vector2(32f, 32f), p.size * ScrollMan.zoom, SpriteEffects.None, 1f);
		base.Draw(p);
	}
}
