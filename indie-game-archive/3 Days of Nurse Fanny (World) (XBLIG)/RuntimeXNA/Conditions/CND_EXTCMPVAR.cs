...
public class CND_EXTCMPVAR : CCnd
{
	...
	public override bool eva2(CRun rhPtr)
	{
		...
		do
		{
			int num2 = ((evtParams[0].code != 53) ? ((PARAM_SHORT)evtParams[0]).value : rhPtr.get_EventExpressionInt((CParamExpression)evtParams[0]));
			if (num2 >= 0 && num2 < 26 && cObject.rov != null)
			{
				cValue.forceValue(cObject.rov.getValue(num2));
