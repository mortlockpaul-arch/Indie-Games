...
public abstract class CRunMvtExtension
{
	...
	{
		CMoveExtension cMoveExtension = (CMoveExtension)ho.rom.rmMovement;
		return cMoveExtension.callParam;
	}
	...
	public virtual bool approachObject(int destX, int destY, int originX, int originY, int htFoot, int planCol, CPoint ptDest)
	{
		...
		bool result = ho.rom.rmMovement.mpApproachSprite(destX, destY, originX, originY, (short)htFoot, (short)planCol, ptDest);
