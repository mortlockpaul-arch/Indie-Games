...
public class FixedPrismaticJoint : Joint
{
	...
	internal override void InitVelocityConstraints(ref TimeStep step)
	{
		...
		if (Settings.EnableWarmstarting)
		{
			...
			Vector2 vector3 = _impulse.X * _perp + (_motorImpulse + _impulse.Z) * _axis;
			float num5 = _impulse.X * _s2 + _impulse.Y + (_motorImpulse + _impulse.Z) * _a2;
	...
	internal override bool SolvePositionConstraints()
	{
		...
		float num9 = vector5.X * _s1 + vector5.Y + vector5.Z * _a1;
		float num10 = vector5.X * _s2 + vector5.Y + vector5.Z * _a2;
		zero -= InvMassA * vector7;
		num -= InvIA * num9;
		c += InvMassB * vector7;
		a += InvIB * num10;
		bodyB.Sweep.c = c;
