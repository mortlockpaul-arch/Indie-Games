...
public static class JointFactory
{
	...
	{
		RevoluteJoint revoluteJoint = CreateRevoluteJoint(bodyA, bodyB, localanchorB);
	...
	{
		Vector2 localPoint = bodyA.GetLocalPoint(bodyB.GetWorldPoint(localanchorB));
		return new WeldJoint(bodyA, bodyB, localPoint, localanchorB);
	}
	...
	{
		Vector2 localPoint = bodyA.GetLocalPoint(bodyB.GetWorldPoint(localanchorB));
		return new LineJoint(bodyA, bodyB, localPoint, localanchorB, axis);
	}
