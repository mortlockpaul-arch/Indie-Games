	...
	public static void Cut(World world, Vector2 start, Vector2 end, float thickness)
	{
		...
		for (int num = 0; num < fixtures.Count; num++)
		{
			if (fixtures[num].Shape.ShapeType == ShapeType.Polygon && fixtures[num].Body.BodyType != BodyType.Static)
			{
				...
				{
					Fixture fixture = FixtureFactory.CreatePolygon(world, first, fixtures[num].Shape.Density, fixtures[num].Body.Position);
					fixture.Body.Rotation = fixtures[num].Body.Rotation;
					fixture.Body.LinearVelocity = fixtures[num].Body.LinearVelocity;
					fixture.Body.AngularVelocity = fixtures[num].Body.AngularVelocity;
					fixture.Body.BodyType = BodyType.Dynamic;
				}
				if (SanityCheck(second))
				{
					Fixture fixture2 = FixtureFactory.CreatePolygon(world, second, fixtures[num].Shape.Density, fixtures[num].Body.Position);
					fixture2.Body.Rotation = fixtures[num].Body.Rotation;
					fixture2.Body.LinearVelocity = fixtures[num].Body.LinearVelocity;
					fixture2.Body.AngularVelocity = fixtures[num].Body.AngularVelocity;
