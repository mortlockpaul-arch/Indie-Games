...
internal class PCircle : IPath
{
	...
	public PCircle(Vector3 _center, float _radius, float _sp, bool _loop)
	{
	...
	public PCircle(Dictionary<string, string> attributes, XmlNode node)
	{
	...
	public virtual void Initialize(Vector3 _center, float _rad, float _sp, bool _loop, float _startRad)
	{
		...
		baseRad = Vector3.Transform(baseRad, Matrix.CreateRotationZ(startRad));
	...
	public virtual void calculate()
	{
		...
		curPos = center + Vector3.Transform(baseRad, Matrix.CreateRotationZ((0f - inc) * speed));
	}
