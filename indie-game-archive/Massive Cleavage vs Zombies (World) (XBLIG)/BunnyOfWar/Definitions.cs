...
public static class Definitions
{
	...
	public static class Options
	{
		...
		public static void SetDifficultyModeSettings()
		{
			...
			else if (Difficulty == 2)
			{
				...
				List<FighterObject> humanPlayers2 = FighterManager.getHumanPlayers(onlyLiving: false, canBeDying: true);
				for (int j = 0; j < humanPlayers2.Count; j++)
				{
					humanPlayers2[j].PROPERTIES.healthMax = HumanHealth;
				}
				CPUAttackSpeed = 0.9f;
			}
			else
			{
				...
				List<FighterObject> humanPlayers3 = FighterManager.getHumanPlayers(onlyLiving: false, canBeDying: true);
				for (int k = 0; k < humanPlayers3.Count; k++)
				{
					humanPlayers3[k].PROPERTIES.healthMax = HumanHealth;
				}
				CPUAttackSpeed = 0.7f;
			}
		}
	...
	public static string CONTENT_DIRECTORY_FOR_LEVEL_EDITOR = "F:\\CraigWorking\\Massive Cleavage\\Project\\Massive Cleavage\\Massive Cleavage\\Massive CleavageContent\\";
	...
	public static int MoveSpeedHuman = 500;
