...
public static class ScreenManager
{
	...
	{
		SoundManager.PlayMusic("menu - The Dread", IsRepeating: true);
	}
	...
	public static void ClearStuffForLevelSwitch()
	{
		Clear();
	...
	public static void ShowRegisterOrBonus(PlayerIndex pi)
	{
		...
		if (!Definitions.Options.RegisteredForBonusContent)
		{
			if (!Guide.IsVisible)
			{
				keyboardResult = Guide.BeginShowKeyboardInput(pi, "Register for Free!", "Please go to www.minotaur.bz/register360.aspx and follow the instructions there.", "", FinishRegisteringWithKeyboardInput, null);
			}
		}
	...
	public static void BroadcastScreenChange(screens screen)
	{
		...
		{
			Networking.packetWriter.Write((byte)18);
			Networking.packetWriter.Write((byte)screen);
