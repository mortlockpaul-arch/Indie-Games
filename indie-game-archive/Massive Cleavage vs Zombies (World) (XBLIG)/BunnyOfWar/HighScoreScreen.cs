...
public static class HighScoreScreen
{
	...
	public static void FigureOutInput(InputFromAnywhere anywhereInput, PlayerIndex pi)
	{
		if (anywhereInput != null)
		{
			...
			else if (ScreenManager.isShowingBuyMeScreen && anywhereInput.X_pressed)
			{
	...
	public static void Draw()
	{
		...
		_ = (screenFullSize - vector2) / 2f;
		_ = GraphicsManager.font.LineSpacing;
		...
		Rectangle rectangle = new Rectangle(backButtonRect.X, backButtonRect.Y, (int)vector3.X, (int)vector3.Y);
