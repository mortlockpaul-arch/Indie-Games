...
public static class FileManager
{
	...
	{
		BeSavedAppend("progress.txt", level);
	}
	...
	public static void BeSaved2(string fileName, string fileData, FileMode writeOrAppend)
	{
		...
		try
		{
			...
			{
				using StreamWriter streamWriter2 = new StreamWriter(container.CreateFile(fileName));
				streamWriter2.Write(fileData);
			}
			container.Dispose();
	...
	{
		delegateLoadFileCallBack delegated = LoadProgressCallback;
		ReadToMe("progress.txt", delegated);
	}
	...
	public static void Screenshot()
	{
		...
		using Stream stream2 = File.OpenWrite("C:\\Users\\MacManzo\\Desktop\\awesome\\screenshot.jpg");
		texture2D.SaveAsJpeg(stream2, 1920, 1080);
	}
}
