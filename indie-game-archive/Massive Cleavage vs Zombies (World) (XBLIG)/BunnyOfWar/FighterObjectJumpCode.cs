...
{
	public int jumpPixelsOffGround;

	public bool jumperIsOnWayUp;
	...
	public bool wasTrulyAirborne;

	private int becameAirborneAtYPixelValue;
	...
	private static int updateEveryXMiliSeconds;
