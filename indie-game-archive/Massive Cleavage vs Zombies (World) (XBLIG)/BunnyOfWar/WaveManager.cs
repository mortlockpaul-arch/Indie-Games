...
public static class WaveManager
{
	...
	public static void Update()
	{
		...
		if (FighterManager.getComputerPlayers(onlyLiving: true, canBeDying: true).Count == 0)
		{
			...
			{
				WaveName? currentWave = CurrentWave;
		...
		WaveName? currentWave2 = CurrentWave;
		if (currentWave2.GetValueOrDefault() == WaveName.Z_End && currentWave2.HasValue)
		{
	...
	{
		_ = GraphicsManager.viewableArea.X;
		_ = GraphicsManager.viewableArea.Y;
		Update();
	}
